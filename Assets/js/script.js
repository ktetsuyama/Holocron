...
$(".column").on("click", function () {
  var posterClicked = $(this).attr("id");
  console.log(posterClicked);
  if (posterClicked === "Ep1") {
    console.log("episode 1 clicked");
  ...
  if (posterClicked === "Ep2") {
    console.log("episode 2 clicked");
    $("#characterChoice").show();
    $("#movie1").hide();
    $("#movie2").show();
    $("#movie3").hide();
  ...
  if (posterClicked === "Ep3") {
    console.log("episode 3 clicked");
    $("#characterChoice").show();
    $("#movie1").hide();
    $("#movie2").hide();
    $("#movie3").show();
  ...
  if (posterClicked === "Ep4") {
    console.log("episode 4 clicked");
    $("#characterChoice").show();
    $("#movie1").hide();
    $("#movie2").hide();
    $("#movie3").hide();
  ...
  if (posterClicked === "Ep5") {
    console.log("episode 5 clicked");
    $("#characterChoice").show();
    $("#movie1").hide();
    $("#movie2").hide();
    $("#movie3").hide();
  ...
  if (posterClicked === "Ep6") {
    console.log("episode 6 clicked");
    $("#characterChoice").show();
    $("#movie1").hide();
    $("#movie2").hide();
    $("#movie3").hide();
...
// show the list of charaters from the chosen fi
// $("#characterChoice").show();
